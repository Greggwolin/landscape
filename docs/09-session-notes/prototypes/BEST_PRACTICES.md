...
cat docs/09_session_notes/prototypes/multifam/rent-roll-inputs/prototype-1.md

# Check user feedback
cat docs/09_session_notes/prototypes/multifam/rent-roll-inputs/feedback.md

# Look at decision log
cat docs/09_session_notes/prototypes/multifam/rent-roll-inputs/decisions.md
```
...
```bash
cp docs/09_session_notes/prototypes/_template.md \
   docs/09_session_notes/prototypes/multifam/rent-roll-inputs/prototype-2.md
```
...
1. **Read First**
   ...
   ls docs/09_session_notes/prototypes/{category}/{feature}/

   # Read version docs
   cat docs/09_session_notes/prototypes/{category}/{feature}/prototype-*.md

   # Read feedback
   cat docs/09_session_notes/prototypes/{category}/{feature}/feedback.md
   ```
...
grep -r "works well" docs/09_session_notes/prototypes/*/feedback.md

# What AI integration patterns exist?
grep -r "AI Integration" docs/09_session_notes/prototypes/*/prototype-*.md

# What table patterns have been used?
grep -r "table" docs/09_session_notes/prototypes/*/prototype-*.md
```

### Learn from Past Issues
```bash
# What hasn't worked?
grep -r "pain point\|doesn't work\|too" docs/09_session_notes/prototypes/*/feedback.md

# What was rejected?
grep -r "Rejected\|Alternative" docs/09_session_notes/prototypes/*/prototype-*.md
```

### Cross-Reference Features
```bash
# Find all MultiFam prototypes
ls docs/09_session_notes/prototypes/multifam/

# Find all prototypes using floor plans
grep -r "floor plan" docs/09_session_notes/prototypes/
```

## Directory Structure

```
docs/09_session_notes/prototypes/
├── README.md                          # This file
...
# 1. Copy template
cp docs/09_session_notes/prototypes/_template.md \
   docs/09_session_notes/prototypes/{category}/{feature}/prototype-1.md
...
```bash
# Find specific term
grep -r "search term" docs/09_session_notes/prototypes/

# Find in feedback only
grep -r "search term" docs/09_session_notes/prototypes/*/feedback.md

# Find in decisions
grep -r "search term" docs/09_session_notes/prototypes/*/decisions.md
```
...
**Current prototypes:**
```bash
cat docs/09_session_notes/prototypes/README.md
```

**Specific prototype status:**
```bash
cat docs/09_session_notes/prototypes/{category}/{feature}/prototype-{n}.md
```
...
**Evolution over time:**
```bash
cat docs/09_session_notes/prototypes/{category}/{feature}/iterations.md
```
