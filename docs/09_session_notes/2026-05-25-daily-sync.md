...
- **Merge prompt:** `LSCMD-SPEC-EXTEND-0521.md` (untracked) contains a PR + squash-merge prompt for this branch. Now 4 days pending.
...
- [ ] **Merge `feat/spec-hidden-and-header-align` into main** — branch is 1 commit ahead, merge prompt (`LSCMD-SPEC-EXTEND-0521.md`) is ready. Fourth day pending — should be first action on next working session.
...
- Immediate action: merge `feat/spec-hidden-and-header-align` branch (merge prompt ready in `LSCMD-SPEC-EXTEND-0521.md`). This has been pending since Wednesday — now 4 days.
