...
- **Merge prompt:** `LSCMD-SPEC-EXTEND-0521.md` (untracked) contains a PR + squash-merge prompt for this branch. Still pending execution.
...
- `0848ed5b` feat(reports): modification_spec adds hidden denylist + alignment overrides (May 21)
- `5f955448` fix(landscaper): block document-profile invention — closes FB-281, FB-291 (May 21)
- `e3fd061e` fix(artifacts): three visual fixes for report artifacts (May 21)
- `f53cdcda` Allow 'subtitle' variant in backend schema validator (May 20)

## Active To-Do / Carry-Forward

- [ ] **Merge `feat/spec-hidden-and-header-align` into main** — branch is 1 commit ahead, merge prompt (`LSCMD-SPEC-EXTEND-0521.md`) is ready. Most immediate next action.
...
- Immediate action: merge `feat/spec-hidden-and-header-align` branch (merge prompt ready in `LSCMD-SPEC-EXTEND-0521.md`).
