# Landscape Rich Schema (Abridged) - 2026-02-26

- Generated at: 2026-02-26T00:15:55.900486Z
- Database host: ep-tiny-lab-af0tg3ps.c-2.us-west-2.aws.neon.tech
- Schema: landscape
- Source JSON: `docs/schema/landscape_rich_schema_2026-02-26.json`
...
Compared against `docs/schema/landscape_rich_schema_2026-02-25.json`.

- Tables: 372 -> 372 (+0)
- Views: 42 -> 42 (+0)
- Indexes: 1246 -> 1246 (+0)
- Constraints: 1071 -> 1071 (+0)
- Foreign_keys: 402 -> 402 (+0)
- Triggers: 62 -> 62 (+0)
- Routines: 995 -> 995 (+0)
...
| tbl_dynamic_column_definition | 17 | 4 | 5 |
...
| tbl_help_conversation | 5 | 1 | 3 |
| tbl_help_message | 6 | 1 | 3 |
| tbl_ic_challenge | 21 | 2 | 3 |
| tbl_ic_session | 14 | 3 | 4 |
...
| tbl_intake_session | 9 | 3 | 4 |
| tbl_inventory_item | 22 | 5 | 12 |
| tbl_item_dependency | 14 | 0 | 3 |
| tbl_knowledge_source | 11 | 0 | 3 |
| tbl_land_comp_adjustments | 7 | 1 | 2 |
| tbl_land_comparables | 20 | 1 | 2 |
| tbl_landscaper_instructions | 8 | 1 | 5 |
| tbl_landscaper_kpi_definition | 9 | 0 | 4 |
| tbl_landuse | 10 | 1 | 5 |
...
| tbl_phase | 11 | 1 | 1 |
| tbl_platform_knowledge | 26 | 1 | 5 |
| tbl_platform_knowledge_chapters | 14 | 1 | 4 |
| tbl_platform_knowledge_chunks | 14 | 2 | 5 |
| tbl_project | 134 | 5 | 14 |
| tbl_project_assumption | 14 | 2 | 5 |
...
| dms_doc_tag_assignments | 4 | 1 | 2 |
| dms_doc_tags | 8 | 0 | 4 |
| dms_extract_queue | 16 | 1 | 4 |
| dms_profile_audit | 9 | 1 | 1 |
| dms_project_doc_types | 6 | 0 | 2 |
...
### extraction_ (2 tables)

| Table | Columns | FK Count | Index Count |
|---|---:|---:|---:|
| extraction_commit_snapshot | 10 | 3 | 5 |
| extraction_mapping_doctype_migration_log | 5 | 0 | 1 |
...
| 16 | core_doc | 36 |
| 17 | tbl_market_rate_analysis | 36 |
| 18 | tbl_sales_comp_land | 36 |
| 19 | tbl_multifamily_unit | 35 |
| 20 | core_doc_media | 34 |
...
| 16 | tbl_dynamic_column_definition | 4 |
| 17 | tbl_milestone | 4 |
| 18 | tbl_model_override | 4 |
| 19 | core_unit_cost_item | 3 |
| 20 | extraction_commit_snapshot | 3 |
| 21 | project_jurisdiction_mapping | 3 |
| 22 | tbl_budget_items | 3 |
| 23 | tbl_commercial_lease | 3 |
| 24 | tbl_contact_relationship | 3 |
| 25 | tbl_cost_allocation | 3 |
| 26 | tbl_expansion_option | 3 |
| 27 | tbl_ic_session | 3 |
| 28 | tbl_intake_session | 3 |
| 29 | tbl_lease | 3 |
| 30 | tbl_loan | 3 |
