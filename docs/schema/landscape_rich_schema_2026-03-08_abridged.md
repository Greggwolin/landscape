...
Generated: 2026-03-08T22:39:46.204944+00:00
Database: ep-tiny-lab-af0tg3ps.c-2.us-west-2.aws.neon.tech
Schema: landscape

## Object Counts
- Tables: 324 (post dead-table cleanup; originally 374 at export time)
- Views: 42
- Indexes: 1252
- Constraints: 1079
- Foreign Keys: 407
...
## Tables (324 active — 10 dropped since export)
...
| property_type | character varying(20) | NO | 'multifamily'::character varying |
...
| plain_password | character varying(128) | YES |  |
...
### core_category_lifecycle_stages_backup_20260126 (5 columns)
| Column | Type | Nullable | Default |
|--------|------|----------|---------|
...
| property_type | character varying(10) | YES | NULL::character varying |
...
| value_source | character varying(20) | YES |  |
...
### core_unit_cost_category_backup_20260126 (12 columns)
| Column | Type | Nullable | Default |
|--------|------|----------|---------|
| category_id | integer | YES |  |
| parent_id | integer | YES |  |
...
| default_uom_code | character varying(10) | YES |  |
...
| created_at | timestamp with time zone | YES | now() |
| updated_at | timestamp with time zone | YES | now() |
| subtype_code | character varying(50) | YES | NULL::character varying |
...
| project_id | integer | NO |  |
| doc_type_name | character varying(100) | NO |  |
| display_order | integer | YES | 0 |
...
| doc_id | integer | NO |  |
| geo_level | character varying(20) | NO |  |
| geo_value | character varying(100) | NO |  |
| geo_source | character varying(20) | YES | 'inferred'::character varying |
| created_at | timestamp with time zone | YES | now() |
...
### extraction_mapping_doctype_migration_log (5 columns)
| Column | Type | Nullable | Default |
|--------|------|----------|---------|
| id | integer | NO | nextval('extraction_mapping_doctype_migration_log_ |
| mapping_id | integer | NO |  |
| old_document_type | character varying(50) | NO |  |
| new_document_type | character varying(50) | NO |  |
...
| created_at | timestamp with time zone | NO |  |
| notes | text | YES |  |
| message_id | character varying(100) | YES |  |
| project_id | integer | NO |  |
...
| project_id | bigint | YES |  |
| workspace_id | bigint | YES |  |
| doc_name | character varying(500) | YES |  |
| doc_type | character varying(100) | YES |  |
| discipline | character varying(100) | YES |  |
...
| folder_name | character varying(255) | YES |  |
| extracted_text | text | YES |  |
| word_count | integer | YES |  |
| media_scan_status | character varying(20) | YES |  |
| media_scan_json | jsonb | YES |  |
| searchable_text | text | YES |  |

### opex_account_migration_map (5 columns)
| Column | Type | Nullable | Default |
|--------|------|----------|---------|
...
| updated_at | timestamp without time zone | YES | now() |
| scenario_id | integer | YES |  |
| confidence | character varying(20) | YES | NULL::character varying |
...
### tbl_acquisition_backup_20260202 (17 columns)
| Column | Type | Nullable | Default |
|--------|------|----------|---------|
...
| user_id | bigint | NO |  |
| draft_name | character varying(200) | YES |  |
| property_type | character varying(50) | YES |  |
| perspective | character varying(50) | YES |  |
...
### tbl_contacts_legacy (31 columns)
| Column | Type | Nullable | Default |
|--------|------|----------|---------|
...
| role | character varying(20) | NO |  |
| content | text | NO |  |
| current_page | character varying(50) | YES |  |
| created_at | timestamp without time zone | NO | now() |
...
| percentile_desc | character varying(100) | YES |  |
...
| status | character varying(30) | NO | 'draft'::character varying |
| created_by | integer | YES |  |
| created_at | timestamp with time zone | YES | now() |
| updated_at | timestamp with time zone | YES | now() |
...
| created_by | character varying(100) | NO |  |
| is_active | boolean | NO |  |
...
| project_id | integer | YES |  |
| instruction_type | character varying(50) | NO | 'custom'::character varying |
...
| user_id | integer | NO | 1 |
| project_type_code | character varying(10) | NO | 'LAND'::character varying |
| kpi_key | character varying(100) | NO |  |
| display_label | character varying(200) | NO |  |
| display_order | integer | NO | 0 |
| is_active | boolean | NO | true |
| created_at | timestamp with time zone | NO | now() |
| updated_at | timestamp with time zone | NO | now() |
...
| division_id | bigint | YES |  |
| unit_id | integer | YES |  |
| field_key | character varying(100) | NO |  |
...
### tbl_operating_expense (16 columns)
| Column | Type | Nullable | Default |
|--------|------|----------|---------|
...
| amount | numeric | YES |  |
| amount_psf | numeric | YES |  |
| percentage_of_revenue | numeric | YES |  |
| is_recoverable | boolean | YES | true |
| recovery_pool | character varying(50) | YES |  |
| annual_growth_pct | numeric | YES | 3.00 |
| notes | text | YES |  |
| created_at | timestamp with time zone | YES | now() |
| updated_at | timestamp with time zone | YES | now() |
| category_name | character varying(200) | YES |  |
...
### tbl_opex_accounts_deprecated (10 columns)
| Column | Type | Nullable | Default |
|--------|------|----------|---------|
| account_id | integer | NO | nextval('tbl_opex_accounts_account_id_seq'::regcla |
...
| sort_order | integer | YES |  |
| created_at | timestamp without time zone | YES | now() |
| applicable_property_types | ARRAY | YES | ARRAY['MF'::text, 'OFF'::text, 'RET'::text, 'IND': |
...
| area_id | integer | YES |  |
| phase_id | integer | YES |  |
| landuse_code | character varying(10) | YES |  |
| landuse_type | character varying(50) | YES |  |
...
### tbl_rent_comparable (21 columns)
| Column | Type | Nullable | Default |
|--------|------|----------|---------|
| comparable_id | integer | NO | nextval('tbl_rent_comparable_comparable_id_seq'::r |
| project_id | integer | NO |  |
...
| contact_name | character varying(200) | YES |  |
| contact_type | character varying(50) | YES |  |
| company_name | character varying(200) | YES |  |
| project_id | bigint | YES |  |
| project_name | character varying(255) | YES |  |
| project_type_code | character varying(50) | YES |  |
| project_is_active | boolean | YES |  |
| role_label | character varying(100) | YES |  |
| role_category | character varying(50) | YES |  |
...
| relationship_type | character varying(50) | YES |  |
| role_title | character varying(200) | YES |  |
| start_date | date | YES |  |
| end_date | date | YES |  |
...
| contact_name | character varying(200) | YES |  |
| contact_type | character varying(50) | YES |  |
| related_to_name | character varying(200) | YES |  |
| related_to_type | character varying(50) | YES |  |
...
| phone | character varying(50) | YES |  |
| phone_mobile | character varying(50) | YES |  |
| role_code | character varying(50) | YES |  |
| role_label | character varying(100) | YES |  |
| role_category | character varying(50) | YES |  |
| role_display_order | integer | YES |  |
| project_name | character varying(255) | YES |  |
...
| lease_id | integer | YES |  |
| project_id | integer | YES |  |
| tenant_name | character varying(255) | YES |  |
| suite_number | character varying(50) | YES |  |
| lease_status | character varying(50) | YES |  |
| lease_type | character varying(50) | YES |  |
| leased_sf | numeric | YES |  |
...
| phase_id | bigint | YES |  |
| parcel_id | bigint | YES |  |
| revenue_stream_name | character varying(200) | YES |  |
| revenue_category | character varying(100) | YES |  |
| start_period | integer | YES |  |
| periods_to_complete | integer | YES |  |
| timing_method | character varying(50) | YES |  |
| units_per_period | numeric | YES |  |
| total_units | integer | YES |  |
| base_price_per_unit | numeric | YES |  |
| price_escalation_pct | numeric | YES |  |
| dependency_id | bigint | YES |  |
| trigger_event | character varying(50) | YES |  |
| trigger_value | numeric | YES |  |
...
| acres | numeric | YES |  |
| source_doc_id | bigint | YES |  |
| source_document | character varying(500) | YES |  |
| source_page | integer | YES |  |
| confidence_score | numeric | YES |  |
| notes | text | YES |  |
| created_at | timestamp without time zone | YES |  |
...
| division_id | bigint | YES |  |
| tier | integer | YES |  |
| division_code | character varying(50) | YES |  |
| division_name | character varying(200) | YES |  |
| parent_division_id | bigint | YES |  |
| category_id | bigint | YES |  |
| cost_code | text | YES |  |
| scope | text | YES |  |
...
| scope | character varying(100) | YES |  |
...
| start_period | integer | YES |  |
| periods_to_complete | integer | YES |  |
| s_curve_profile | character varying(50) | YES |  |
...
| loan_id | bigint | YES |  |
| project_id | bigint | YES |  |
| loan_name | character varying(255) | YES |  |
| loan_type | character varying(50) | YES |  |
| structure_type | character varying(20) | YES |  |
...
| mapping_id | integer | YES |  |
| document_type | character varying(50) | YES |  |
| source_pattern | character varying(200) | YES |  |
...
|--------|------|----------|---------|
| dependency_id | bigint | YES |  |
| dependent_item_type | character varying(50) | YES |  |
| dependent_item_table | character varying(100) | YES |  |
...
| source_file | character varying(200) | YES |  |
| survey_period | character varying(20) | YES |  |
| project_name | character varying(200) | YES |  |
| master_plan_name | character varying(200) | YES |  |
| master_plan_id | character varying(50) | YES |  |
| master_plan_developer | character varying(200) | YES |  |
| builder_name | character varying(200) | YES |  |
...
| use_type_name | character varying(50) | YES |  |
| product_code | text | YES |  |
| product_name | character varying(50) | YES |  |
| base_price_per_unit | numeric | YES |  |
| growth_rate | numeric | YES |  |
...
| buyer_name | character varying(200) | YES |  |
| buyer_entity | character varying(200) | YES |  |
| sale_status | character varying(50) | YES |  |
| gross_value | numeric | YES |  |
| net_proceeds | numeric | YES |  |
| commission_pct | numeric | YES |  |
| closing_cost_per_unit | numeric | YES |  |
...
| Column | Type | Nullable | Default |
|--------|------|----------|---------|
| jurisdiction_name | character varying(100) | YES |  |
...
| jurisdiction_county | text | YES |  |
| jurisdiction_state | character(2) | YES |  |
| family_name | text | YES |  |
| district_code | text | YES |  |
| district_name | text | YES |  |
