...
const LandUseCanvas: React.FC<LandUseCanvasProps> = ({
  ...
  const getDirectFamilyLandUses = (familyName: string) => {
    ...
    return landuses.filter(l => 
      l.subtype_id === null && 
      l.active && 
      patterns.includes(l.landuse_code)
    );
  };
                          ...
                          {(() => {
                            ...
                            return directLandUses.length > 0 ? (
                              <div className="space-y-2">
                                <div className="text-xs text-gray-400 mb-2">Direct Land Uses:</div>
                                {directLandUses.map((landuse) => (
                                  <div 
                                    key={landuse.landuse_id}
                                  ...
                                  >
                                    ...
                                    {landuse.description && (
                                      <div className="text-xs text-gray-300 mt-1">{landuse.description}</div>
                                    )}
                                  </div>
                                ))}
                              </div>
