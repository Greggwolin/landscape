...
export function NestedExpenseTable({
  ...
  return (
    <div className="rounded border" style={{ backgroundColor: 'var(--cui-body-bg)', borderColor: 'var(--cui-border-color)' }}>
      ...
      <div className="px-4 py-2 border-b" style={{ backgroundColor: 'var(--surface-card-header)', borderColor: 'var(--cui-border-color)' }}>
            ...
            {filteredRows.length === 0 ? (
              ...
              filteredRows.map(row => (
                <tr
                  ...
                  style={{
                    borderColor: 'var(--cui-border-color)',
                    backgroundColor: row.isParent ? 'var(--surface-subheader)' : 'var(--cui-body-bg)'
                  }}
                >
