...
export default function MultiFamRentRollInputsContentPage() {
  ...
  const renderCellContent = (unit: Unit, columnId: string) => {
    ...
    switch (columnId) {
      ...
      case 'bedrooms':
        return <span className="text-gray-300">{unit.bedrooms}</span>;
      case 'bathrooms':
        return <span className="text-gray-300">{unit.bathrooms}</span>;
      case 'sqft':
        return <span className="text-gray-300">{unit.sqft.toLocaleString()}</span>;
      case 'currentRent':
        return isEdit ? (
          <input
            type="number"
          ...
          unit.status === 'Vacant' ? '—' : `$${unit.currentRent.toLocaleString()}`
        );
      case 'marketRent':
        return isEdit ? (
          <input
          ...
          <span className="text-white font-medium">${unit.marketRent.toLocaleString()}</span>
        );
      case 'proformaRent':
        return isEdit ? (
          <input
          ...
          <span className="text-gray-300">${unit.proformaRent.toLocaleString()}</span>
        );
      case 'status':
        return isEdit ? (
          <select
      ...
      case 'deposit':
        return isEdit ? (
          ...
          unit.deposit ? `$${unit.deposit.toLocaleString()}` : '—'
        );
      case 'monthlyIncome':
        return <span className="text-gray-300">${unit.monthlyIncome.toLocaleString()}</span>;
      case 'rentPerSF':
        return <span className="text-gray-300">${unit.rentPerSF.toFixed(2)}</span>;
      case 'proformaRentPerSF':
        return <span className="text-gray-300">${unit.proformaRentPerSF.toFixed(2)}</span>;
      case 'notes':
        return isEdit ? (
          <input
            type="text"
                      ...
                      <tr key={plan.id} className={`border-b border-gray-700 ${index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-850'}`}>
                        ...
                        <td className="px-3 py-2 text-center">
                          {editing ? (
                            ...
                            <span className="text-gray-300">{plan.bedrooms}</span>
                          )}
                        </td>
                        <td className="px-3 py-2 text-center">
                          {editing ? (
                            ...
                            <span className="text-gray-300">{plan.bathrooms}</span>
                          )}
                        </td>
                        <td className="px-3 py-2 text-center">
                          {editing ? (
                            ...
                            <span className="text-gray-300">{plan.sqft.toLocaleString()}</span>
                          )}
                        </td>
                        <td className="px-3 py-2 text-center">
                          {editing ? (
                            ...
                            <span className="text-gray-300">{plan.unitCount}</span>
                          )}
                        </td>
                        <td className="px-3 py-2 text-center">
                          {editing ? (
                            ...
                            <span className="text-gray-300">${plan.currentRent.toLocaleString()}</span>
                          )}
                        </td>
                        <td className="px-3 py-2 text-center">
                          {editing ? (
                            ...
                            <span className="text-white font-medium">
                              ${plan.marketRent.toLocaleString()}
                ...
                <tbody>
                  {comparables.map((comp, index) => (
                    <tr key={comp.id} className={`border-b border-gray-700 ${index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-850'}`}>
                      ...
                      <td className="px-2 py-1.5 text-center text-gray-300">{comp.bedrooms}/{comp.bathrooms}</td>
                      <td className="px-2 py-1.5 text-center text-gray-300">{comp.sqft.toLocaleString()}</td>
                      <td className="px-2 py-1.5 text-center text-gray-300">{comp.distance} mi</td>
                      <td className="px-2 py-1.5 text-right text-white font-medium">${comp.askingRent.toLocaleString()}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <div className="bg-gray-800 rounded border border-gray-700">
        ...
        <div className="px-4 py-3 grid grid-cols-6 gap-3 border-b border-gray-700">
          ...
          <div className="bg-gray-750 rounded-lg p-3 border border-gray-700">
            ...
            <div className="text-2xl font-bold text-white">${avgCurrentRent.toLocaleString()}</div>
          ...
          <div className="bg-gray-750 rounded-lg p-3 border border-gray-700">
            ...
            <div className="text-2xl font-bold text-white">${avgMarketRent.toLocaleString()}</div>
            <div className="text-xs text-gray-500 mt-1">Per unit/month</div>
          </div>
          ...
          <div className="bg-gray-750 rounded-lg p-3 border border-gray-700">
            ...
            <div className="text-2xl font-bold text-green-400">+{rentGrowthPotential}%</div>
          ...
          <div className="bg-gray-750 rounded-lg p-3 border border-gray-700">
            ...
            <div className="text-2xl font-bold text-white">${(totalMonthlyIncome / 1000).toFixed(1)}k</div>
          ...
          <div className="bg-gray-750 rounded-lg p-3 border border-gray-700">
            ...
            <div className="text-2xl font-bold text-white">${avgRentPerSF}</div>
