...
urlpatterns = [
    ...
    path('projects/<int:project_id>/docs/<int:doc_id>/versions/', list_document_versions, name='list_document_versions'),
    path('projects/<int:project_id>/docs/<int:doc_id>/link-version/', link_document_version, name='link_document_version'),
    path('projects/<int:project_id>/docs/<int:doc_id>/restore-version/', restore_document_version, name='restore_document_version'),
