...
def capture_feedback(
    ...
    try:
        with connection.cursor() as cursor:
            ...
            # tbl_feedback is the single source of truth — the /admin/feedback
            # page reads it directly (apps.feedback.views_canonical). The old
            # tester_feedback mirror was removed in LSCMD-FBUNIFY-0613-qz.
            return feedback_id
    except Exception as e:
