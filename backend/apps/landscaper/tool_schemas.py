            ...
            "properties": {
                ...
                "artifact_subtype": {
                    ...
                    "description": (
                        ...
                        "from Income through Net Operating Income. Subsection labels (Taxes & "
                        "Insurance, Utilities, Repairs & Maintenance, Administrative, Management "
                        "& Reserves) appear as ROWS in the same table where ONLY the `line` cell "
                        "is populated and the other cells are blank or null. Section headings "
                        "(Income, Operating Expenses) likewise appear as rows. Subtotal and "
                        "total rows (Gross Potential Rent, Effective Gross Income, Total "
                        "Operating Expenses, Net Operating Income) MUST be rows in this same "
                        "table — NOT separate kv_grid blocks. The renderer applies bold + rules "
                        "automatically when row labels match these canonical phrases. Do NOT "
                        "split Operating Expenses into multiple sibling table blocks — that "
                        "produces duplicated column headers, which is not allowed. "
                        "Do NOT include property metadata (units count, square feet, year built, "
                        "address, zoning) in any kv_grid — that content belongs on a Property "
                        "Profile artifact. Property NAME and reporting PERIOD are allowed as "
                        "kv_grid header pairs."
                    ),
                },
                "edit_target": {
