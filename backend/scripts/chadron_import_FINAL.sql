-- ============================================================================
-- CHADRON RENT ROLL DATABASE IMPORT - FINAL VERSION
-- Generated: 2025-01-11
-- Units: 113 | Current GPR: $258,543/mo | Proforma GPR: $363,083/mo
-- ============================================================================

BEGIN;

\echo '===================================='
\echo 'Chadron Rent Roll Import Starting'
\echo '====================================
...
\echo '✅ Temp table loaded with 113 units'
\echo ''

-- Step 2: Update unit types
...
SELECT
    ...
    to_char(calculated, 'FM$999,999.99') as calculated,
    to_char(expected, 'FM$999,999.99') as expected,
    to_char(calculated - expected, 'FM$999,999.99') as variance,
    ROUND(ABS(calculated - expected) / expected * 100, 2) || '%' as pct,
...
UNION ALL
SELECT 'Occupied' as metric, COUNT(*) FROM landscape.tbl_multifamily_lease WHERE project_id = 17 AND lease_status = 'ACTIVE'
UNION ALL
...
-- Leave transaction open for manual commit/rollback
