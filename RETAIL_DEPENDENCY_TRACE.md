...
| credit_loss_pct | No | Yes | Default 1.0% |
| has_percentage_rent | No | Yes | Default false |
| sales_volume_annual | No | Yes | Default/zero |
| percentage_rent_rate | No | Yes | Default 5.0% |
...
| other_income_total OR (specialty_leasing_income + temp_tenant_income + kiosk_income + parking_income + storage_income + telecom_income + misc_income) | No | Yes | Defaults/zero |

**OR Conditions:** `scheduled_base_rent` OR rent-roll rollup; `occupancy_pct` OR `physical_vacancy_pct`; `other_income_total` OR line-item sum.
...
| real_estate_taxes | Yes | No | — |
| property_insurance | Yes | No | — |
| management_fee_pct | No | Yes | Default 3.5% |
| administrative | No | Yes | Default/zero |
| marketing_fund | No | Yes | Default/zero |
| recovery_method | Yes | No | — |
| cam_recovery_pct | No | Yes | Default 100% |
| tax_recovery_pct | No | Yes | Default 100% |
| insurance_recovery_pct | No | Yes | Default 100% |
