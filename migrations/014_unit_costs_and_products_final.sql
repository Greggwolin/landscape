-- =====================================================
-- Migration 014: Unit Costs & Product Library Foundations (FINAL)
-- =====================================================
...
-- =====================================================
-- 1. Ensure tbl_measures has required system codes
-- =====================================================

-- tbl_measures already exists, just ensure we have the required codes
INSERT INTO landscape.tbl_measures (measure_code, measure_name, measure_category, is_system) VALUES
  ('DAY', 'Day', 'time', TRUE),
  ('WK', 'Week', 'time', TRUE),
  ('MO', 'Month', 'time', TRUE),
  ('YR', 'Year', 'time', TRUE),
  ('%', 'Percent', 'ratio', TRUE),
  ('EA', 'Each', 'count', TRUE),
  ('LF', 'Linear Foot', 'length', TRUE),
  ('SF', 'Square Foot', 'area', TRUE),
  ('SY', 'Square Yard', 'area', TRUE),
  ('CY', 'Cubic Yard', 'volume', TRUE),
  ('LS', 'Lump Sum', 'none', TRUE)
...
-- =====================================================
-- 4. Benchmark link table (using correct table name)
-- =====================================================
...
CREATE TABLE IF NOT EXISTS landscape.core_template_benchmark_link (
  ...
  benchmark_id BIGINT REFERENCES landscape.tbl_global_benchmark_registry(benchmark_id) ON DELETE CASCADE,
...
-- =====================================================
-- 5. Product library enhancements
-- =====================================================
...
-- =====================================================
-- 6. Planning standards catalog and project override
-- =====================================================
