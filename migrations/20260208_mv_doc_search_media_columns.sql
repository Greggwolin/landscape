-- Migration: Add media_scan_status and media_scan_json to mv_doc_search view
-- Date: 2026-02-08
-- Description: Include media scan columns so DMS list view can render badge chips
-- Depends on: 009_dms_media_assets.sql (added columns to core_doc)

-- Recreate the view with media scan columns
...
-- ROLLBACK:
-- DROP VIEW IF EXISTS landscape.mv_doc_search CASCADE;
-- Then recreate without the media_scan_status and media_scan_json columns
