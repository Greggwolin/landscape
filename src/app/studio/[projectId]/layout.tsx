...
import '@/styles/studio.css'; // studio-specific deltas — keep last

/**
 * Project-scoped layout for the isolated Studio shell (/studio/[projectId]).
 *
 ...
 * stack the reused CenterChatPanel + modal bridge need. Mirrors the provider
 * composition of /w/projects/[projectId]/layout.tsx, plus WrapperUIProvider on
 * top (which the /w/ outer shell would otherwise supply).
 *
 * Additive and isolated: classic /projects/[id] and the /w/ shell are untouched.
 */
