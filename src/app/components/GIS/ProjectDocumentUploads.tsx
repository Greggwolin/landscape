...
const InlineFieldControl: React.FC<InlineFieldControlProps> = ({
 ...
 if (choice === 'ai') return 'border-blue-500 bg-blue-50 '
 if (choice === 'custom') return 'border-purple-500 bg-purple-50 '
 return 'border bg-body-tertiary '
 }

 return (
 <div className={`border rounded-md p-2 ${isCommitted ? 'bg-green-900/20 border-green-500' : 'bg-body border'}`}>
 <div className="flex items-start gap-3">
 {/* Label on the left inside box */}
 <div className="w-28 flex-shrink-0 text-xs font-medium text-body-tertiary pt-1">
 ...
 {/* DVL Match Indicator */}
 {isDvlValidating && (
 <span className="text-xs text-body-tertiary flex-shrink-0 flex items-center gap-1">
 <div className="animate-spin w-3 h-3 border border border-t-transparent rounded-full"></div>
 Checking DVL...
 </span>
 )}
 ...
 className="px-2 py-1 text-xs bg-blue-600 text-body rounded hover:bg-blue-700 flex items-center gap-1"
 >
 <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
 ...
 />
 <span className="text-xs text-body-tertiary">Custom</span>
 </label>
 ...
 />
 <span className="text-xs text-body-tertiary">Skip</span>
 </label>
 ...
 className="w-full px-2 py-1 text-xs border border rounded bg-body text-body placeholder-gray-400 focus:ring-1 focus:ring-purple-500 focus:border-purple-500"
 />
 {isValidating && (
 <span className="absolute right-2 top-1/2 -translate-y-1/2 text-xs text-body-tertiary">
 Validating...
 </span>
 )}
 </div>
 ...
 className="px-2 py-1 text-xs bg-green-600 text-body rounded hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed ml-auto"
 >
 Save
 </button>
 </div>
 ...
 <div className="mt-1 text-xs text-body-tertiary">
 {validationMessage}
 </div>
 )}
 ...
 <div className="mt-2 border border-blue-500 rounded-md bg-body p-3">
 <div className="flex items-center justify-between mb-2">
 <h5 className="text-xs font-semibold text-blue-400">Chat with AI</h5>
 <button
 onClick={() => setShowChatPanel(false)}
 className="text-body-tertiary hover:text-body-tertiary"
 >
 ...
 <div className="text-xs text-body-tertiary italic">
 ...
 {msg.content}
 {msg.proposedValue && (
 <div className="mt-1 pt-1 border-t border">
 ...
 <div className="inline-block px-2 py-1 rounded bg-body text-body-tertiary">
 ...
 className="flex-1 px-2 py-1 text-xs border border rounded bg-body text-body placeholder-gray-500 focus:ring-1 focus:ring-blue-500"
 disabled={isChatting}
 />
 <button
 onClick={handleSendMessage}
 disabled={isChatting || !currentMessage.trim()}
 className="px-2 py-1 text-xs bg-blue-600 text-body rounded hover:bg-blue-700 disabled:opacity-50"
 >
 Send
 </button>
 </div>
 ...
 className="w-full mt-2 px-2 py-1 text-xs bg-green-600 text-body rounded hover:bg-green-700"
 >
...
const ProjectDocumentUploads: React.FC<ProjectDocumentUploadsProps> = ({
 ...
 <div className="bg-body rounded-lg max-w-6xl w-full max-h-[90vh] overflow-y-auto border border">
 <div className="p-6">
 {/* Header */}
 <div className="flex items-center justify-between mb-6">
 <div>
 <h2 className="text-2xl font-bold text-body">Project Document Upload & Analysis</h2>
 <p className="text-body-tertiary mt-1">
 ...
 {/* Package Name */}
 <div className="mb-6">
 <label className="block text-sm font-medium text-body-tertiary mb-2">
 Package Name *
 </label>
 <input
 type="text"
 ...
 className="w-full px-3 py-2 border border rounded-md bg-body text-body placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
 />
 </div>
 ...
 <>
 <div className="mb-6">
 <h3 className="text-lg font-medium text-body mb-4">Upload Document</h3>
 <Dropzone
 projectId={projectId}
 ...
 <div className="mb-6">
 <h3 className="text-lg font-medium text-body mb-4">
 Uploaded Document
 </h3>
 <div className="space-y-2">
 {uploadedDocuments.map((doc, index) => (
 <div key={doc.doc_id} className="bg-body rounded-lg p-3 flex items-center justify-between border border">
 ...
 <div className="mb-6 bg-body border border rounded-lg p-3 flex items-center justify-between">
 <div className="flex items-center gap-3">
 ...
 className="px-3 py-1 text-xs text-body-tertiary bg-body rounded hover:bg-body"
 >
 Change Document
 </button>
 </div>
 ...
 <div className="w-1/2 bg-body border border rounded-lg p-4">
 <h4 className="text-sm font-semibold text-body mb-3 flex items-center gap-2">
 ...
 <div className="text-sm text-body-tertiary space-y-3">
 {uploadedDocuments.length > 0 ? (
 <>
 <div>
 <span className="text-body-tertiary">Document:</span>{' '}
 <span className="text-body font-medium">{uploadedDocuments[0].doc_name}</span>
 </div>
 <div className="border-t border pt-3">
 <p className="text-body-tertiary leading-relaxed">
 ...
 <p className="text-body-tertiary leading-relaxed mt-3">
 ...
 <p className="text-body-tertiary italic">Upload a document to see AI-generated summary</p>
 )}
 </div>
 </div>
 </div>
 ...
 type="button"
 onClick={onCancel}
 className="px-4 py-2 text-sm font-medium text-body-tertiary bg-body border border rounded-md hover:bg-body focus:outline-none focus:ring-2 focus:ring-gray-500"
 >
 Cancel
 </button>
 )}
 ...
 className="px-6 py-2 text-sm font-medium text-body bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
 >
