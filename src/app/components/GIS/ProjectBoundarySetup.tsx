...
export default function ProjectBoundarySetup({
 ...
 return (
 <div className="w-full h-full flex flex-col bg-body">
 {/* Header */}
 <div className="bg-body border-b border px-6 py-4">
 <div className="flex items-center justify-between">
 <div>
 <h2 className="text-xl font-bold text-body">Define Project Boundary</h2>
 ...
 <button
 onClick={onCancel}
 className="px-4 py-2 text-sm font-medium text-body-tertiary hover:text-body"
 >
 Back
 </button>
 )}
 ...
 <h3 className="text-lg font-semibold text-body mb-3">From Your Documents</h3>
 ...
 {/* Selection Summary */}
 <div className="p-4 border-b border">
 <h3 className="text-lg font-semibold text-body mb-3">Selected Tax Parcels</h3>
 ...
 <div key={parcel.PARCELID || `parcel-${index}`} className="p-3 border-b border">
 <div className="flex items-start justify-between">
 <div className="flex-1 min-w-0">
 <div className="text-body font-medium text-sm truncate">
 {parcel.SITEADDRESS || 'No Address'}
 </div>
 <div className="text-body-tertiary text-xs mt-1">
 ID: {parcel.PARCELID}
 </div>
 <div className="text-body-tertiary text-xs mt-1">
 ...
 {parcel.OWNERNME1 && (
 <div className="text-body-tertiary text-xs truncate">
 ...
 className="ml-2 text-body-tertiary hover:text-red-400 text-xs"
 >
 Remove
 </button>
 </div>
 ...
 className="w-full px-4 py-2 bg-blue-600 text-body rounded-md disabled:bg-body disabled:cursor-not-allowed font-medium"
 >
 {isSubmitting ? 'Saving Boundary...' : `Confirm Boundary (${selectedParcels.length} parcels)`}
 </button>

 <div className="mt-2 text-xs text-body-tertiary text-center">
