...
const labelClass = 'text-xs font-semibold uppercase tracking-wide text-body-tertiary'
const valueClass = 'text-sm text-body'
...
const ProjectSummaryPreview = ({ data, uploadedDocuments, extractionPending }: ProjectSummaryPreviewProps) => {
 ...
 return (
 <div className="rounded-lg border border bg-body/40 p-6">
