...
export default function BudgetGrid({ projectId }: BudgetGridProps) {
 ...
 : 'Geography';
 return <Chip label={label} size="small" onDelete={() => setDivisionFilter('')} sx={{ bgcolor: 'var(--cui-primary-bg-subtle)', color: 'var(--cui-primary)' }} />;
 })()}
 {stageFilter && <Chip label={`Stage: ${stageFilter}`} size="small" onDelete={() => setStageFilter('')} sx={{ bgcolor: 'var(--cui-success-bg-subtle)', color: 'var(--cui-success)' }} />}
 {scopeFilter && <Chip label={`Scope: ${scopeFilter}`} size="small" onDelete={() => setScopeFilter('')} sx={{ bgcolor: 'var(--cui-warning-bg-subtle)', color: 'var(--cui-warning)' }} />}
 {categoryFilter && <Chip label={`Category: ${categoryFilter}`} size="small" onDelete={() => setCategoryFilter('')} sx={{ bgcolor: 'var(--cui-info-bg-subtle)', color: 'var(--cui-info)' }} />}
 <Chip
 label="Clear Filters"
