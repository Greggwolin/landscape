...
const materioTheme = createTheme({
 palette: {
 mode: 'light',
 primary: { main: 'var(--cui-primary)', contrastText: 'var(--cui-body-color)' },
 secondary: { main: 'var(--cui-success)' },
 background: { default: 'var(--cui-body-bg)', paper: 'var(--cui-body-color)' },
...
const MarketAssumptionsNative: React.FC<Props> = ({ projectId = 7 }) => {
 ...
 case 'residential':
 return { backgroundColor: 'var(--cui-success)', color: 'var(--cui-body-color)' } // Green
 case 'commercial':
 return { backgroundColor: 'var(--cui-warning)', color: 'var(--cui-body-color)' } // Orange
 case 'industrial':
 return { backgroundColor: 'var(--cui-danger)', color: 'var(--cui-body-color)' } // Red
 case 'mixed use':
 return { backgroundColor: 'var(--cui-primary)', color: 'var(--cui-body-color)' } // Purple
 case 'open space':
 return { backgroundColor: 'var(--cui-info)', color: 'var(--cui-body-color)' } // Cyan
 default:
 return { backgroundColor: 'var(--cui-secondary-color)', color: 'var(--cui-body-color)' } // Gray
 }
 }
 ...
 switch (category) {
 case 'DEVELOPMENT_COSTS': return 'var(--cui-primary)';
 case 'PRICE_APPRECIATION': return 'var(--cui-success)';
 case 'SALES_ABSORPTION': return 'var(--cui-warning)';
 default: return 'var(--cui-primary)';
 }
 }
 ...
 handleCustomToggle(cardId)
        ...
        sx={{
          backgroundColor: isExpanded ? color : 'var(--cui-warning)',
          minWidth: 50,
          fontSize: '0.65rem',
          textTransform: 'none',
          height: 18,
 ...
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)', width: '20%' }}>Family</TableCell>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)', width: '30%' }}>Description</TableCell>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)', width: '12%' }}>LU Code</TableCell>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)', textAlign: 'right', width: '20%' }}>$/Unit</TableCell>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)', textAlign: 'center', width: '9%' }}>Unit</TableCell>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)', textAlign: 'center', width: '9%' }}>Inflate</TableCell>
 </TableRow>
 </TableHead>
 <TableBody>
 ...
 <TableHead>
 <TableRow sx={{ backgroundColor: 'rgba(138, 141, 147, 0.16)' }}>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)', width: '50%' }}>Item</TableCell>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)', textAlign: 'center', width: '20%' }}>Amount</TableCell>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)', textAlign: 'center', width: '12%' }}>Unit</TableCell>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)', textAlign: 'center', width: '18%' }}>Inflate</TableCell>
 </TableRow>
 </TableHead>
 <TableBody>
 {/* Planning & Engineering Section */}
 <TableRow sx={{ backgroundColor: 'rgba(138, 141, 147, 0.08)' }}>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)' }} colSpan={4}>Planning & Engineering</TableCell>
 </TableRow>
 <TableRow>
 ...
 {/* Development Section */}
 <TableRow sx={{ backgroundColor: 'rgba(138, 141, 147, 0.08)' }}>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)' }} colSpan={4}>Development</TableCell>
 </TableRow>
 <TableRow>
 ...
 {/* Operations Section */}
 <TableRow sx={{ backgroundColor: 'rgba(138, 141, 147, 0.08)' }}>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)' }} colSpan={4}>Operations</TableCell>
 </TableRow>
 <TableRow>
 ...
 {/* Other Section */}
 <TableRow sx={{ backgroundColor: 'rgba(138, 141, 147, 0.08)' }}>
 <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', color: 'var(--cui-body-color)' }} colSpan={4}>Other</TableCell>
 </TableRow>
 <TableRow>
