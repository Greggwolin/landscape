  ...
  return (
    <div className={`space-y-4 ${className}`}>
      ...
      <div>
        ...
        {loadingFamilies && (
          <p className="text-xs text-gray-400 mt-1">Loading families...</p>
        )}
      </div>
      ...
      <div>
        ...
        {loadingDensity && (
          <p className="text-xs text-gray-400 mt-1">Loading density classifications...</p>
        )}
      </div>
      ...
      <div>
        ...
        {loadingTypes && (
          <p className="text-xs text-gray-400 mt-1">Loading types...</p>
        )}
        {!selectedFamily && (
      ...
      {(selectedFamily || selectedDensity || selectedType || selectedProduct) && (
        <div className="bg-gray-700 border border-gray-600 rounded-md p-3 mt-4">
          <h4 className="font-medium text-sm text-gray-300 mb-2">Current Selection</h4>
