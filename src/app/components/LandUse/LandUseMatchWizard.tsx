...
const LandUseMatchWizard: React.FC<LandUseMatchWizardProps> = ({
 ...
 try {
 setLoading(true);
 const url = projectId  ? `/api/landuse/mapping?action=analyze&project_id=${projectId}`
 ...
 <div className="bg-body rounded-lg p-6 w-96">
 ...
 <div className="text-sm text-body-tertiary mb-4">
 All {analysis.analysis.matched_codes} land use codes from your parcels  are already mapped to the land use management system.
 </div>
 <button
 onClick={onClose}
 ...
 return (
 <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
 <div className="bg-body rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
 {/* Header */}
 <div className="flex justify-between items-center mb-6 pb-4 border-b border">
 <div>
 <h2 className="text-xl font-semibold text-body">Land Use Code Mapping Wizard</h2>
 <p className="text-body-tertiary text-sm">
 ...
 <h3 className="text-lg font-medium text-body mb-3">Analysis Summary</h3>
 <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
 <div>
 <div className="text-body-tertiary">Total Parcel Codes</div>
 <div className="text-body font-semibold">{analysis.analysis.total_parcel_codes}</div>
 </div>
 <div>
 <div className="text-body-tertiary">Matched Codes</div>
 <div className="text-green-400 font-semibold">{analysis.analysis.matched_codes}</div>
 </div>
 <div>
 <div className="text-body-tertiary">Need Mapping</div>
 <div className="text-yellow-400 font-semibold">{analysis.analysis.unmatched_parcel_codes}</div>
 </div>
 <div>
 <div className="text-body-tertiary">Available in System</div>
 ...
 <h3 className="text-lg font-medium text-body">Map Unmatched Codes</h3>
  {analysis.unmatched_parcel_codes.map((unmatchedCode) => (
 <div key={unmatchedCode.code} className="p-4 bg-body rounded-lg border border">
 <div className="flex items-center justify-between mb-3">
 <div>
 <span className="text-body font-medium">{unmatchedCode.code}</span>
 <span className="text-body-tertiary ml-2">
 ...
 className="w-full p-2 bg-body border border rounded text-body"
 >
 ...
 className="p-2 bg-body border border rounded text-body"
 />
 <input
 type="text"
