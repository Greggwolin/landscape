...
const LandUseDetails: React.FC<LandUseDetailsProps> = ({ subtype, onClose }) => {
 ...
 const subtypeLandUses = Array.isArray(landusesData)  ? landusesData.filter((lu: LandUse) =>  (lu.subtype_id === subtype.subtype_id || lu.subtype_id == null || lu.subtype_id === 0)  && lu.active
 )
 : [];
 ...
 <div className="absolute right-0 top-0 h-full w-2/3 bg-body border-l border shadow-xl flex flex-col">
 {/* Header */}
 ...
 <p className="text-sm text-body-tertiary">Development Standards & Products</p>
 </div>
 <button
 onClick={onClose}
 ...
 : 'text-body-tertiary hover:text-body-tertiary'
 }`}
 >
 ...
 <div className="text-body-tertiary">Loading subtype details...</div>
 </div>
 ) : (
 <div>
 {activeTab === 'specs' && (
 ...
 Add Standard
  ...
  {resSpecs.map(spec => (
 <div key={spec.res_spec_id} className="bg-body rounded-lg p-4 mb-4">
 <div className="grid grid-cols-3 gap-4">
 <div>
 <h4 className="text-sm font-medium text-body-tertiary mb-2">Density</h4>
 ...
 <div>Min Lot: {formatNumber(spec.lot_area_min_sf, ' sf')}</div>
  ...
  <div>
 <h4 className="text-sm font-medium text-body-tertiary mb-2">Lot Dimensions</h4>
 <div className="text-body">
 ...
 <div>Min Depth: {formatNumber(spec.lot_d_min_ft, ' ft')}</div>
  ...
  <div>
 <h4 className="text-sm font-medium text-body-tertiary mb-2">Building</h4>
 <div className="text-body">
 ...
 <div>Max Coverage: {formatNumber(spec.cov_max_pct, '%')}</div>
  ...
  <div>
 <h4 className="text-sm font-medium text-body-tertiary mb-2">Setbacks (ft)</h4>
 ...
 <div>Corner: {formatNumber(spec.sb_corner_ft)}</div>
  ...
  <div>
 <h4 className="text-sm font-medium text-body-tertiary mb-2">Requirements</h4>
 <div className="text-body text-sm">
 ...
 <p className="text-sm text-body-tertiary">{spec.notes}</p>
 </div>
 )}
 </div>
 ))}
 ...
 Add Standard
  ...
  {comSpecs.map(spec => (
 <div key={spec.com_spec_id} className="bg-body rounded-lg p-4 mb-4">
 <div className="grid grid-cols-3 gap-4">
 <div>
 <h4 className="text-sm font-medium text-body-tertiary mb-2">Intensity</h4>
 <div className="text-body">
 ...
 <div>Min Open Space: {formatNumber(spec.os_min_pct, '%')}</div>
  ...
  <div>
 <h4 className="text-sm font-medium text-body-tertiary mb-2">Parking</h4>
 <div className="text-body">
 ...
 <h4 className="text-sm font-medium text-body-tertiary mb-2">Setbacks (ft)</h4>
 <div className="text-body text-sm grid grid-cols-4 gap-2">
 <div>Front: {formatNumber(spec.sb_front_ft)}</div>
 <div>Side: {formatNumber(spec.sb_side_ft)}</div>
 <div>Rear: {formatNumber(spec.sb_rear_ft)}</div>
 <div>Corner: {formatNumber(spec.sb_corner_ft)}</div>
 ...
 <div>
 <div className="flex items-center justify-between mb-4">
 <h3 className="text-lg font-semibold text-body">Lot Products</h3>
 <button className="btn btn-primary btn-sm d-inline-flex align-items-center">
 <Plus className="w-4 h-4 me-1" />
 Add Product
 </button>
 ...
 <div key={product.product_id} className="bg-body rounded-lg p-4">
 <div className="flex items-center justify-between mb-2">
 <h4 className="font-medium text-body">{product.code}</h4>
 <button
 className="btn btn-sm btn-ghost-primary"
 ...
 <div>
 <div className="flex items-center justify-between mb-4">
 <h3 className="text-lg font-semibold text-body">Land Use Codes</h3>
 <button className="btn btn-primary btn-sm d-inline-flex align-items-center">
 <Plus className="w-4 h-4 me-1" />
 Add Code
 </button>
 ...
 const isGeneral = !landuse.subtype_id || landuse.subtype_id === 0;
  return (
 <div key={landuse.landuse_id} className="bg-body rounded-lg p-4">
 <div className="flex items-center justify-between mb-2">
 <div className="flex items-center gap-2">
 <h4 className="font-medium text-body">{landuse.landuse_code}</h4>
 {isSpecific && (
 <span className="px-2 py-1 bg-blue-600 text-xs text-body rounded">
 Specific
 </span>
 )}
 {isGeneral && (
 <span className="px-2 py-1 bg-body text-xs text-body-tertiary rounded">
 General
 </span>
 )}
 <div className="text-sm text-body-tertiary">({landuse.landuse_type})</div>
 </div>
 <button
 className="btn btn-sm btn-ghost-primary"
 ...
 <div className="mt-1 text-body-tertiary">{landuse.description}</div>
 )}
 {isGeneral && (
