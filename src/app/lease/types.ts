/**
 * Lease prototype types.
 *
 * These mirror the shape of the mock fixture in
 * `src/app/api/lease/mock-data.ts`. The module was previously missing,
 * leaving that import unresolved (TS2307). Defined here from the fixture
 * shapes so the lease prototype routes type-check.
 */
...
export interface TenantImprovement {
  ...
  reimbursement_structure: string;
}
