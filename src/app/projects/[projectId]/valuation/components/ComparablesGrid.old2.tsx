            ...
            <tbody>
              ...
              <tr className="border-b" style={{ borderColor: 'var(--cui-border-color)' }}>
                ...
                {comparables.map(comp => (
                  ...
                  >
                    <div className="font-medium">{comp.property_name || 'Unnamed'}</div>
                  ...
                  {comparables.map(comp => (
                    <>
                      <th
                        ...
                        className="py-2 px-2 text-xs font-normal border-l"
                        style={{
                          color: 'var(--cui-secondary-color)',
                          borderColor: 'var(--cui-border-color)'
                        }}
              ...
              {adjustmentTypes.includes('market_conditions') && (
                <tr className="border-b" style={{ borderColor: 'var(--cui-border-color)' }}>
                  <td
                    className="py-2 px-4 pl-8 sticky left-0 z-10"
                    style={{
                      color: 'var(--cui-secondary-color)',
                      backgroundColor: 'var(--cui-card-bg)'
                    }}
              ...
              >
                ...
                {comparables.map(comp => (
                  <td
                    ...
                    colSpan={3}
                    className="py-2 px-4 font-bold text-right border-l"
                    style={{
              ...
              <tr style={{ backgroundColor: 'var(--cui-tertiary-bg)' }}>
                ...
                {comparables.map(comp => (
                  <td
                    ...
                    colSpan={3}
                    className="py-3 px-4 font-bold text-base text-right border-l"
                    style={{
