...
export default function LocationSubTab({ project }: LocationSubTabProps) {
  ...
  // Delay slightly to let savedAnalysesLoaded have time to set t1AutoGenerated
  useEffect(() => {
    if (
      ...
      // Small delay to avoid race with the DB load setting t1AutoGenerated
      const timer = setTimeout(() => {
        if (!t1AutoGenerated.current) {
