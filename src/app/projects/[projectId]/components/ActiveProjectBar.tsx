  ...
  return (
    <div
      ...
      style={{
        ...
        alignItems: 'stretch',
        gap: '0.75rem',
        padding: '0.5rem var(--app-padding, 0.5rem)',
        flexShrink: 0,
        position: 'sticky',
        top: '58px',
        zIndex: 40,
        ...
        marginLeft: 'calc(-1 * var(--app-padding, 0.5rem))',
        marginRight: 'calc(-1 * var(--app-padding, 0.5rem))',
        marginTop: 'calc(-1 * var(--app-padding, 0.5rem))',
        marginBottom: 'var(--component-gap)',
        width: 'calc(100% + 2 * var(--app-padding, 0.5rem))',
      }}
    >
