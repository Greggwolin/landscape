...
// Generated on: 2026-06-08T23:15:41.193Z
...
export namespace LandscapeSchema {
  export type Migrations = Migrations;
  export type AiCorrectionLog = AiCorrectionLog;
  export type AiDebugLog = AiDebugLog;
  export type AiDocumentSubtypes = AiDocumentSubtypes;
  export type AiExtractionStaging = AiExtractionStaging;
  export type AiExtractionWarnings = AiExtractionWarnings;
  export type AiIngestionHistory = AiIngestionHistory;
  export type AiReviewHistory = AiReviewHistory;
  export type AuthGroup = AuthGroup;
  export type AuthGroupPermissions = AuthGroupPermissions;
  export type AuthPermission = AuthPermission;
  export type AuthUser = AuthUser;
  export type AuthUserGroups = AuthUserGroups;
  export type AuthUserUserPermissions = AuthUserUserPermissions;
  export type BmkAbsorptionVelocity = BmkAbsorptionVelocity;
  export type BmkBuilderCommunities = BmkBuilderCommunities;
  export type BmkBuilderInventory = BmkBuilderInventory;
  export type BmkBuilderPlans = BmkBuilderPlans;
  export type BmkResaleClosings = BmkResaleClosings;
  export type CoreCategoryLifecycleStages = CategoryLifecycleStages;
  export type CoreCategoryTagLibrary = CategoryTagLibrary;
  export type CoreDoc = Doc;
  export type CoreDocAttrEnum = DocAttrEnum;
  export type CoreDocAttrLookup = DocAttrLookup;
  export type CoreDocFolder = DocFolder;
  export type CoreDocFolderLink = DocFolderLink;
  export type CoreDocMedia = DocMedia;
  export type CoreDocMediaLink = DocMediaLink;
  export type CoreDocSmartfilter = DocSmartfilter;
  export type CoreDocText = DocText;
  export type CoreFinBudgetVersion = FinBudgetVersion;
  export type CoreFinCategoryUom = FinCategoryUom;
  export type CoreFinConfidencePolicy = FinConfidencePolicy;
  ...
  export type CoreFinDivisionApplicability = FinDivisionApplicability;
  ...
  export type CoreItemBenchmarkLink = ItemBenchmarkLink;
  export type CoreLookupItem = LookupItem;
  export type CoreLookupList = LookupList;
  export type CoreLookupVw = LookupVw;
  export type CorePlanningStandards = PlanningStandards;
  export type CoreUnitCostCategory = UnitCostCategory;
  export type CoreUnitCostItem = UnitCostItem;
  export type CoreWorkspaceMember = WorkspaceMember;
  export type DensityClassification = DensityClassification;
  export type DeveloperFees = DeveloperFees;
  export type DjangoAdminLog = DjangoAdminLog;
  export type DjangoContentType = DjangoContentType;
  export type DjangoMigrations = DjangoMigrations;
  export type DjangoSession = DjangoSession;
  export type DmsAssertion = DmsAssertion;
  export type DmsAttributes = DmsAttributes;
  export type DmsDocTagAssignments = DmsDocTagAssignments;
  export type DmsDocTags = DmsDocTags;
  export type DmsExtractQueue = DmsExtractQueue;
  export type DmsProfileAudit = DmsProfileAudit;
  export type DmsProjectDocTypes = DmsProjectDocTypes;
  export type DmsTemplateAttributes = DmsTemplateAttributes;
  export type DmsTemplates = DmsTemplates;
  export type DmsUnmapped = DmsUnmapped;
  export type DmsWorkspaces = DmsWorkspaces;
  export type DocExtractedFacts = DocExtractedFacts;
  export type DocGeoTag = DocGeoTag;
  export type DocProcessingQueue = DocProcessingQueue;
  export type DocumentTables = DocumentTables;
  export type ExtractionCommitSnapshot = ExtractionCommitSnapshot;
  export type GeographyColumns = GeographyColumns;
  export type GeometryColumns = GeometryColumns;
  export type GisBoundaryHistory = GisBoundaryHistory;
  export type GisDocumentIngestion = GisDocumentIngestion;
  export type GisMappingHistory = GisMappingHistory;
  export type GisPlanParcel = GisPlanParcel;
  export type GisProjectBoundary = GisProjectBoundary;
  export type GisTaxParcelRef = GisTaxParcelRef;
  export type GlossaryZoning = GlossaryZoning;
  export type KnowledgeEmbeddings = KnowledgeEmbeddings;
  export type KnowledgeEntities = KnowledgeEntities;
  export type KnowledgeFacts = KnowledgeFacts;
  export type KnowledgeInsights = KnowledgeInsights;
  export type KnowledgeInteractions = KnowledgeInteractions;
  export type KnowledgeSessions = KnowledgeSessions;
  export type LandUsePricing = LandUsePricing;
  export type LandscaperAbsorptionDetail = LandscaperAbsorptionDetail;
  export type LandscaperActivity = LandscaperActivity;
  export type LandscaperAdvice = LandscaperAdvice;
  export type LandscaperChatEmbedding = LandscaperChatEmbedding;
  export type LandscaperChatMessage = LandscaperChatMessage;
  export type LandscaperChatThread = LandscaperChatThread;
  export type LandscaperThreadMessage = LandscaperThreadMessage;
  export type LkpBuildingClass = LkpBuildingClass;
  export type LkpBuyerSellerType = LkpBuyerSellerType;
  export type LkpPriceStatus = LkpPriceStatus;
  export type LkpSaleType = LkpSaleType;
  export type LuAcreageAllocationType = AcreageAllocationType;
  export type LuComSpec = ComSpec;
  export type LuFamily = Family;
  export type LuLeaseStatus = LeaseStatus;
  export type LuLeaseType = LeaseType;
  export type LuMarket = Market;
  export type LuMediaClassification = MediaClassification;
  export type LuPicklistDisplayConfig = PicklistDisplayConfig;
  export type LuPropertySubtype = PropertySubtype;
  export type LuRecoveryStructure = RecoveryStructure;
  export type LuResSpec = ResSpec;
  export type LuSubtype = Subtype;
  export type LuType = Type;
  export type ManagementOverhead = ManagementOverhead;
  export type MarketActivity = MarketActivity;
  export type MarketAssumptions = MarketAssumptions;
  export type MarketCompetitiveProjectExclusions = MarketCompetitiveProjectExclusions;
  export type MarketCompetitiveProjectProducts = MarketCompetitiveProjectProducts;
  export type MarketCompetitiveProjects = MarketCompetitiveProjects;
  export type MktDataSourceRegistry = MktDataSourceRegistry;
  export type MktNewHomeProject = MktNewHomeProject;
  export type MktPermitHistory = MktPermitHistory;
  export type MutationAuditLog = MutationAuditLog;
  export type MvDocSearch = MvDocSearch;
  export type OpexBenchmark = OpexBenchmark;
  export type OpexLabelMapping = OpexLabelMapping;
  export type PendingMutations = PendingMutations;
  export type PlanningDoc = PlanningDoc;
  export type ProjectBoundaries = ProjectBoundaries;
  export type ProjectJurisdictionMapping = ProjectJurisdictionMapping;
  export type ProjectLandUse = ProjectLandUse;
  export type ProjectLandUseProduct = ProjectLandUseProduct;
  export type ProjectParcelBoundaries = ProjectParcelBoundaries;
  export type ReportTemplates = ReportTemplates;
  export type ResLotProduct = ResLotProduct;
  export type SaleNames = SaleNames;
  export type SpatialRefSys = SpatialRefSys;
  export type TblAbsorptionSchedule = AbsorptionSchedule;
  export type TblAcquisition = Acquisition;
  export type TblAcreageAllocation = AcreageAllocation;
  export type TblAdditionalIncome = AdditionalIncome;
  export type TblAiAdjustmentSuggestions = AiAdjustmentSuggestions;
  export type TblAlphaFeedback = AlphaFeedback;
  export type TblAnalysisDraft = AnalysisDraft;
  export type TblAnalysisTypeConfig = AnalysisTypeConfig;
  export type TblApproval = Approval;
  export type TblArea = Area;
  export type TblArtifact = Artifact;
  export type TblArtifactVersion = ArtifactVersion;
  export type TblAssumptionSnapshot = AssumptionSnapshot;
  export type TblAssumptionrule = Assumptionrule;
  export type TblBaseRent = BaseRent;
  export type TblBenchmarkAiSuggestions = BenchmarkAiSuggestions;
  export type TblBenchmarkContingency = BenchmarkContingency;
  export type TblBenchmarkTransactionCost = BenchmarkTransactionCost;
  export type TblBenchmarkUnitCost = BenchmarkUnitCost;
  export type TblBudget = Budget;
  export type TblBudgetFact = BudgetFact;
  ...
  export type TblCabinet = Cabinet;
  export type TblCalculationPeriod = CalculationPeriod;
  export type TblCapRateComps = CapRateComps;
  export type TblCapexReserve = CapexReserve;
  export type TblCapitalCall = CapitalCall;
  export type TblCapitalReserves = CapitalReserves;
  export type TblCapitalization = Capitalization;
  export type TblCashflow = Cashflow;
  export type TblCashflowSummary = CashflowSummary;
  export type TblChangelog = Changelog;
  export type TblClosingEvent = ClosingEvent;
  export type TblCommercialLeaseArchive_20260506 = CommercialLeaseArchive20260506;
  export type TblConcept = Concept;
  export type TblConceptCategory = ConceptCategory;
  export type TblConceptField = ConceptField;
  export type TblContact = Contact;
  export type TblContactRelationship = ContactRelationship;
  export type TblContactRole = ContactRole;
  export type TblCostAllocation = CostAllocation;
  export type TblCostApproach = CostApproach;
  export type TblCostApproachDepreciation = CostApproachDepreciation;
  export type TblDcfAnalysis = DcfAnalysis;
  export type TblDebtDrawSchedule = DebtDrawSchedule;
  export type TblDivision = Division;
  export type TblDocumentProject = DocumentProject;
  export type TblDynamicColumnDefinition = DynamicColumnDefinition;
  export type TblDynamicColumnValue = DynamicColumnValue;
  export type TblEquity = Equity;
  export type TblEquityDistribution = EquityDistribution;
  export type TblEquityPartner = EquityPartner;
  export type TblEquityStructure = EquityStructure;
  export type TblEscalation = Escalation;
  export type TblExcelAudit = ExcelAudit;
  export type TblExcelAuditFinding = ExcelAuditFinding;
  export type TblExecutive = Executive;
  export type TblExecutiveCompensationPeriod = ExecutiveCompensationPeriod;
  export type TblExecutiveEmploymentAgreement = ExecutiveEmploymentAgreement;
  export type TblExecutiveIncentiveTarget = ExecutiveIncentiveTarget;
  export type TblExpansionOption = ExpansionOption;
  export type TblExpenseComparable = ExpenseComparable;
  export type TblExpenseDetail = ExpenseDetail;
  export type TblExpenseRecoveryArchive_20260506 = ExpenseRecoveryArchive20260506;
  export type TblExtractionJob = ExtractionJob;
  export type TblExtractionLog = ExtractionLog;
  export type TblExtractionMapping = ExtractionMapping;
  export type TblFeedback = Feedback;
  export type TblFieldCatalog = FieldCatalog;
  export type TblFieldCatalogBackup_20260324 = FieldCatalogBackup20260324;
  export type TblFinanceStructure = FinanceStructure;
  export type TblGlobalBenchmarkRegistry = GlobalBenchmarkRegistry;
  export type TblGuarantorFinancialPeriod = GuarantorFinancialPeriod;
  export type TblHbuAnalysis = HbuAnalysis;
  export type TblHbuComparableUse = HbuComparableUse;
  export type TblHbuZoningDocument = HbuZoningDocument;
  export type TblHelpConversation = HelpConversation;
  export type TblHelpMessage = HelpMessage;
  export type TblIcChallenge = IcChallenge;
  export type TblIcSession = IcSession;
  export type TblIncomeApproach = IncomeApproach;
  export type TblIncomeProperty = IncomeProperty;
  export type TblIncomePropertyIndExt = IncomePropertyIndExt;
  export type TblIncomePropertyMfExt = IncomePropertyMfExt;
  export type TblIncomePropertyRetExt = IncomePropertyRetExt;
  export type TblIntakeSession = IntakeSession;
  export type TblInventoryItem = InventoryItem;
  export type TblItemDependency = ItemDependency;
  export type TblKnowledgeSource = KnowledgeSource;
  export type TblLandCompAdjustments = LandCompAdjustments;
  export type TblLandComparables = LandComparables;
  export type TblLandscaperInstructions = LandscaperInstructions;
  export type TblLandscaperKpiDefinition = LandscaperKpiDefinition;
  export type TblLanduse = Landuse;
  export type TblLanduseProgram = LanduseProgram;
  export type TblLease = Lease;
  export type TblLeaseArchive_20260506 = LeaseArchive20260506;
  export type TblLeaseAssumptions = LeaseAssumptions;
  export type TblLeaseIndExt = LeaseIndExt;
  export type TblLeaseMfExt = LeaseMfExt;
  export type TblLeaseNlExt = LeaseNlExt;
  export type TblLeaseRetExt = LeaseRetExt;
  export type TblLeaseRevenueTiming = LeaseRevenueTiming;
  export type TblLeasingCommission = LeasingCommission;
  export type TblLoan = Loan;
  export type TblLoanContainer = LoanContainer;
  export type TblLoanFinanceStructure = LoanFinanceStructure;
  export type TblLocationBrief = LocationBrief;
  export type TblLot = Lot;
  export type TblLotType = LotType;
  export type TblMarketRateAnalysis = MarketRateAnalysis;
  export type TblMasterLease = MasterLease;
  export type TblMasterLeaseAmendment = MasterLeaseAmendment;
  export type TblMasterLeaseProperty = MasterLeaseProperty;
  export type TblMeasures = Measures;
  export type TblMilestone = Milestone;
  export type TblModelOverride = ModelOverride;
  export type TblMsa = Msa;
  export type TblMultifamilyLease = MultifamilyLease;
  export type TblMultifamilyProperty = MultifamilyProperty;
  export type TblMultifamilyTurn = MultifamilyTurn;
  export type TblMultifamilyUnit = MultifamilyUnit;
  export type TblMultifamilyUnitType = MultifamilyUnitType;
  export type TblNarrativeChange = NarrativeChange;
  export type TblNarrativeComment = NarrativeComment;
  export type TblNarrativeVersion = NarrativeVersion;
  export type TblOperatingExpenses = OperatingExpenses;
  export type TblOperationsUserInputs = OperationsUserInputs;
  export type TblOperator = Operator;
  export type TblOperatorAlias = OperatorAlias;
  export type TblOperatorConcept = OperatorConcept;
  export type TblOperatorPrincipal = OperatorPrincipal;
  export type TblOperatorPrincipalDistribution = OperatorPrincipalDistribution;
  export type TblOpexTiming = OpexTiming;
  export type TblParcel = Parcel;
  export type TblParcelAcquisitionHistory = ParcelAcquisitionHistory;
  export type TblParcelSaleAssumptions = ParcelSaleAssumptions;
  export type TblParcelSaleEvent = ParcelSaleEvent;
  export type TblParticipationPayment = ParticipationPayment;
  export type TblPercentageRentArchive_20260506 = PercentageRentArchive20260506;
  export type TblPhase = Phase;
  export type TblPlatformKnowledge = PlatformKnowledge;
  export type TblPlatformKnowledgeChapters = PlatformKnowledgeChapters;
  export type TblPlatformKnowledgeChunks = PlatformKnowledgeChunks;
  export type TblPrincipalFinancialStatement = PrincipalFinancialStatement;
  export type TblProject = Project;
  export type TblProjectAssumption = ProjectAssumption;
  export type TblProjectConfig = ProjectConfig;
  export type TblProjectContact = ProjectContact;
  export type TblProjectInventoryColumns = ProjectInventoryColumns;
  export type TblProjectMetrics = ProjectMetrics;
  export type TblProjectSettings = ProjectSettings;
  export type TblPropertyAcquisition = PropertyAcquisition;
  export type TblPropertyApn = PropertyApn;
  export type TblPropertyAttributeDef = PropertyAttributeDef;
  export type TblPropertyTypeConfig = PropertyTypeConfig;
  export type TblPropertyUseTemplate = PropertyUseTemplate;
  export type TblRecovery = Recovery;
  export type TblRenewalOption = RenewalOption;
  export type TblRentConcession = RentConcession;
  export type TblRentEscalationArchive_20260506 = RentEscalationArchive20260506;
  export type TblRentRoll = RentRoll;
  export type TblRentRollUnit = RentRollUnit;
  export type TblRentScheduleArchive_20260506 = RentScheduleArchive20260506;
  export type TblRentStep = RentStep;
  export type TblRentalComparable = RentalComparable;
  export type TblReportDefinition = ReportDefinition;
  export type TblReportHistory = ReportHistory;
  export type TblResearchFinancialData = ResearchFinancialData;
  export type TblResearchHarvestLog = ResearchHarvestLog;
  export type TblResearchPublication = ResearchPublication;
  export type TblRevenueOther = RevenueOther;
  export type TblRevenueRent = RevenueRent;
  export type TblRevenueTiming = RevenueTiming;
  export type TblSaleBenchmarks = SaleBenchmarks;
  export type TblSalePhases = SalePhases;
  export type TblSaleSettlement = SaleSettlement;
  export type TblSalesCompAdjustments = SalesCompAdjustments;
  export type TblSalesCompContacts = SalesCompContacts;
  export type TblSalesCompHistory = SalesCompHistory;
  export type TblSalesCompHospitality = SalesCompHospitality;
  export type TblSalesCompIndustrial = SalesCompIndustrial;
  export type TblSalesCompLand = SalesCompLand;
  export type TblSalesCompManufactured = SalesCompManufactured;
  export type TblSalesCompMarketConditions = SalesCompMarketConditions;
  export type TblSalesCompOffice = SalesCompOffice;
  export type TblSalesCompRetail = SalesCompRetail;
  export type TblSalesCompSelfStorage = SalesCompSelfStorage;
  export type TblSalesCompSpecialtyHousing = SalesCompSpecialtyHousing;
  export type TblSalesCompStorageUnitMix = SalesCompStorageUnitMix;
  export type TblSalesCompTenants = SalesCompTenants;
  export type TblSalesCompUnitMix = SalesCompUnitMix;
  export type TblSalesComparables = SalesComparables;
  export type TblScenario = Scenario;
  export type TblScenarioComparison = ScenarioComparison;
  export type TblScenarioLog = ScenarioLog;
  export type TblSecurityDeposit = SecurityDeposit;
  export type TblSpace = Space;
  export type TblSpaceIndExt = SpaceIndExt;
  export type TblSpaceMfExt = SpaceMfExt;
  export type TblSpaceRetExt = SpaceRetExt;
  export type TblSystemPicklist = SystemPicklist;
  export type TblTemplateColumnConfig = TemplateColumnConfig;
  export type TblTenant = Tenant;
  export type TblTenantImprovement = TenantImprovement;
  export type TblTerminationOption = TerminationOption;
  export type TblUnitOperations = UnitOperations;
  export type TblUomCalculationFormulas = UomCalculationFormulas;
  export type TblUserGridPreference = UserGridPreference;
  export type TblUserLandscaperProfile = UserLandscaperProfile;
  export type TblUserPreference = UserPreference;
  export type TblUserReportPersonalDefault = UserReportPersonalDefault;
  export type TblUserSavedReport = UserSavedReport;
  export type TblUserScenarioVocab = UserScenarioVocab;
  export type TblVacancyAssumption = VacancyAssumption;
  export type TblValuationReconciliation = ValuationReconciliation;
  export type TblValueAddAssumptions = ValueAddAssumptions;
  export type TblWaterfall = Waterfall;
  export type TblWaterfallTier = WaterfallTier;
  export type TblZoningControl = ZoningControl;
  export type TesterFeedback = TesterFeedback;
  export type TypeLotProduct = TypeLotProduct;
  export type UserProfile = UserProfile;
  export type UserSettings = UserSettings;
  export type VAiReviewSummary = VAiReviewSummary;
  export type VContactProjects = VContactProjects;
  export type VContactRelationships = VContactRelationships;
  export type VLeaseSummary = VLeaseSummary;
  export type VProjectContacts = VProjectContacts;
  export type VProjectContactsDetail = VProjectContactsDetail;
  export type VRentRoll = VRentRoll;
  export type VSalesComparablesFull = VSalesComparablesFull;
  export type VwAbsorptionWithDependencies = AbsorptionWithDependencies;
  export type VwAcreageAllocation = AcreageAllocation;
  export type VwBudgetGridItems = BudgetGridItems;
  export type VwBudgetVariance = BudgetVariance;
  export type VwBudgetWithDependencies = BudgetWithDependencies;
  export type VwCategoryHierarchy = CategoryHierarchy;
  export type VwDebtBalanceSummary = DebtBalanceSummary;
  export type VwDocMediaSummary = DocMediaSummary;
  export type VwExtractionMappingStats = ExtractionMappingStats;
  export type VwItemDependencyStatus = ItemDependencyStatus;
  export type VwLeaseExpirationSchedule = LeaseExpirationSchedule;
  export type VwMapPlanParcels = MapPlanParcels;
  export type VwMapTaxParcels = MapTaxParcels;
  export type VwMktAbsorptionByLotWidth = MktAbsorptionByLotWidth;
  export type VwMktAbsorptionByLuProduct = MktAbsorptionByLuProduct;
  export type VwMktCurrentProjects = MktCurrentProjects;
  export type VwMktLandscaperSummary = MktLandscaperSummary;
  export type VwMktPricingByCityLotwidth = MktPricingByCityLotwidth;
  export type VwMultifamilyLeaseExpirations = MultifamilyLeaseExpirations;
  export type VwMultifamilyOccupancySummary = MultifamilyOccupancySummary;
  export type VwMultifamilyProjectSummary = MultifamilyProjectSummary;
  export type VwMultifamilyTurnMetrics = MultifamilyTurnMetrics;
  export type VwMultifamilyUnitStatus = MultifamilyUnitStatus;
  export type VwParcelsWithSales = ParcelsWithSales;
  export type VwPermitAnnualByJurisdiction = PermitAnnualByJurisdiction;
  export type VwPermitMsaMonthly = PermitMsaMonthly;
  export type VwProjectAcquisitionSummary = ProjectAcquisitionSummary;
  export type VwRevenueTimeline = RevenueTimeline;
  export type VwZoningGlossaryExport = ZoningGlossaryExport;
  export type ZondaSubdivisions = ZondaSubdivisions;
}
