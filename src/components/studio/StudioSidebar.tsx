...
/**
 * StudioSidebar — the REAL unified-UI sidebar for the /studio shell.
 *
 ...
 * PLUS the project folder/sub-tab tree via the additive `projectNav` prop. The
 * studio left panel is therefore byte-identical to /w/ — real icons, global nav,
 * the dashboard/project-switch path — with the folder tree added as one section.
 *
 * Global nav routes back into the /w/ surfaces (Projects/Home → dashboard +
 * project picker); recent-project rows route to /studio/[id] to stay in the
 * studio context. /w/ behavior is untouched (it simply never renders here).
 */
...
export function StudioSidebar({
  ...
  // ── Chat-generated artifacts (studio "Artifacts" section) ────────────
