    ...
    <CModal visible={visible} onClose={onClose} size="lg" alignment="center">
      ...
      <CModalBody className="space-y-4">
        ...
        <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-3 text-sm text-gray-700 dark:text-gray-200">
          <div className="text-xs uppercase tracking-[0.2em] text-gray-400 mb-2">Landscaper Analysis</div>
          {analysis}
        </div>

        <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-3">
          <div className="text-xs uppercase tracking-[0.2em] text-gray-400 mb-2">Suggested Cataloging</div>

          <div className="grid grid-cols-1 gap-3">
            <div>
              <label className="text-xs font-medium text-gray-600 dark:text-gray-300">Knowledge Domain</label>
              <select
            ...
            <div>
              <label className="text-xs font-medium text-gray-600 dark:text-gray-300">Property Types</label>
              <div className="mt-2 flex flex-wrap gap-3">
                {PROPERTY_TYPE_OPTIONS.map((option) => (
                  <label key={option} className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-300">
                    <input
                      type="checkbox"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-xs font-medium text-gray-600 dark:text-gray-300">Source</label>
                <select
                  className="mt-1 w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
            ...
            <div>
              <label className="text-xs font-medium text-gray-600 dark:text-gray-300">Geographic Scope</label>
              <select
                className="mt-1 w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
            ...
            <div>
              <label className="text-xs font-medium text-gray-600 dark:text-gray-300">Supersedes (optional)</label>
              <input
                type="text"
                className="mt-1 w-full rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-2 text-sm"
      ...
      <CModalFooter>
        <button
          type="button"
          onClick={onClose}
          className="px-4 py-2 text-sm rounded-md border border-gray-200 dark:border-gray-700"
