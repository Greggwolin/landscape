...
export default function PlatformKnowledgeTable({
 ...
 {/* Toolbar */}
 <div className="flex items-center justify-between px-3 py-2 border-b border bg-body">
 ...
 <th className="px-3 py-2 text-left text-sm font-medium text-body-secondary">Title</th>
 )}
 {isColumnVisible('domain') && (
 <th className="px-3 py-2 text-left text-sm font-medium text-body-secondary">Domain</th>
 )}
 {isColumnVisible('source') && (
 <th className="px-3 py-2 text-left text-sm font-medium text-body-secondary">Source</th>
 )}
 {isColumnVisible('year') && (
 <th className="px-3 py-2 text-center text-sm font-medium text-body-secondary">Year</th>
 )}
 {isColumnVisible('scope') && (
 <th className="px-3 py-2 text-left text-sm font-medium text-body-secondary">Scope</th>
 )}
 {isColumnVisible('status') && (
 <th className="px-3 py-2 text-left text-sm font-medium text-body-secondary">Status</th>
 )}
 {isColumnVisible('updated') && (
 <th className="px-3 py-2 text-left text-sm font-medium text-body-secondary">Updated</th>
 )}
 ...
 {isColumnVisible('year') && (
 <td className="px-3 py-3 text-center text-sm text-body-secondary">
 ...
 <span className="text-xs text-body-tertiary">Not indexed</span>
 )}
 </td>
 )}
 </tr>
