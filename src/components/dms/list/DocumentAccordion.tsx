...
export default function DocumentAccordion({
 ...
 <div style={{
 backgroundColor: 'var(--cui-tertiary-bg, var(--cui-tertiary-bg))',
 ...
 >
 <CIcon icon={cilLightbulb} className="w-4 h-4" style={{ color: 'var(--cui-warning)' }} />
 <span>Summarize</span>
 </button>
 ...
 >
 <CIcon icon={cilList} className="w-4 h-4" style={{ color: 'var(--cui-success)' }} />
 ...
 >
 <CIcon icon={cilBook} className="w-4 h-4" style={{ color: 'var(--cui-primary)' }} />
 ...
 >
 <CIcon icon={cilCog} className="w-4 h-4" style={{ color: 'var(--cui-info)' }} />
 <span>Q&A prep</span>
 </button>
