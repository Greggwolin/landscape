 ...
 */
 ...
 ${borderColor}
 ${activeUploading ? 'opacity-50 cursor-not-allowed' : 'hover:border-blue-400 hover:bg-blue-50 '}
 `}
 >
 <input {...getInputProps()} />
 ...
 <div className="w-full bg-body-tertiary rounded-full h-2">
 <div
 ...
 <p className="text-xs text-body-tertiary mt-1">
 ...
 {/* Upload context info */}
 <div className="mt-4 p-3 bg-body-tertiary rounded-lg">
 <h4 className="text-sm font-medium text-body mb-2">
 Upload Context
 </h4>
 <div className="grid grid-cols-2 gap-2 text-xs text-body-secondary">
 <div>
