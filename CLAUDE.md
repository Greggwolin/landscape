...
| 7 | Landscaper Chat | ✅ WORKS | 274 tools (master list refreshed 2026-07-21; +`get_budget_rollup` tool, demo question battery runner, fabrication guard figure-trace instrumentation); thread-based with unassigned (pre-project) threads, tightened firing discipline, cross-property fabrication blocked |
...
| Landscaper chat | — | ✅ | 274 tools, Claude AI |
