...
DELETE FROM landscape.tbl_cre_base_rent WHERE lease_id IN (SELECT lease_id FROM landscape.tbl_lease WHERE cre_property_id = 1);
DELETE FROM landscape.tbl_cre_rent_escalation WHERE lease_id IN (SELECT lease_id FROM landscape.tbl_lease WHERE cre_property_id = 1);
DELETE FROM landscape.tbl_cre_expense_recovery WHERE lease_id IN (SELECT lease_id FROM landscape.tbl_lease WHERE cre_property_id = 1);
DELETE FROM landscape.tbl_cre_tenant_improvement WHERE lease_id IN (SELECT lease_id FROM landscape.tbl_lease WHERE cre_property_id = 1);
DELETE FROM landscape.tbl_cre_leasing_commission WHERE lease_id IN (SELECT lease_id FROM landscape.tbl_lease WHERE cre_property_id = 1);
DELETE FROM landscape.tbl_lease WHERE cre_property_id = 1;
