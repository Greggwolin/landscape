        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mb-3">
              ...
              {/* Template badge - placeholder for now */}
              <div className="flex items-center gap-2">
                <span className="text-sm text-gray-400">Complexity:</span>
                <span className="px-3 py-1 bg-gray-700 border border-gray-600 rounded text-gray-300 text-sm">
                  Standard
                </span>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors opacity-50 cursor-not-allowed"
              disabled
              title="Document upload coming in Phase 2"
            >
